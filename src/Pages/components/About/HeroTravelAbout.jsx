...
export default function HeroTravelAbout() {
  return (
    <div className='w-full h-[65vh] my-3 flex items-center font-geo'>
        <div className=' bg-heroTravel bg-center bg-cover h-[80%] w-[95vw] sm:w-[90vw] mx-auto rounded-[50px]' style={{
          ...
          backgroundBlendMode: 'multiply'
            ...
            <div className='flex flex-col justify-center items-start w-[100%] md:w-[70%] h-full px-5 sm:px-10 xl:px-36 text-light'>
                <h1 className='text-3xl sm:text-5xl md:text-6xl leading-snug font-bold'>Enjoy your travel</h1>
